...
// //task1
// let freightorder=results.filter(item => item.order.freight<1);
// console.log(freightorder);


// //task 2
// let ernshorder=results.filter(item => item.order.customerId==="ERNSH");
//  console.log(ernshorder);

// // task 3
// let emplyeesort=results.sort((a,b)=> a.order.employeeId-b.order.employeeId);
// console.log(emplyeesort);

// // task 4
// console.log(results.filter(item=>item.orderDetails.length>3));

// //task 5
//  console.log(results.find(item=>item.order.id===11058));